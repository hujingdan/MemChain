import "./chunk-5C3GVEK7.js";
import "./chunk-C54IFJPC.js";
import {
  init,
  throttle
} from "./chunk-GHN2UECX.js";
import "./chunk-TIUZWAZ5.js";
import {
  Teleport,
  computed,
  defineComponent,
    ...
    if (root$1 && chart$1 && autoresize$1) {
      ...
      ro = new ResizeObserver(() => {
        if (!initialResizeTriggered) {
          ...
          if (root$1.offsetWidth === offsetWidth && root$1.offsetHeight === offsetHeight)
            return;
        }
        if (root$1.offsetWidth === 0 || root$1.offsetHeight === 0)
          return;
        resizeCallback();
      });
      ro.observe(root$1);
...
var ECharts_default = defineComponent({
  ...
  setup(props, { attrs, expose, slots }) {
    ...
    function resolveUpdateOptions(plan) {
      ...
      if ((plan == null ? void 0 : plan.notMerge) !== void 0)
